...
<head>
    ...
    <style>
        ...
        .start-pacman {
            ...
            background:-moz-linear-gradient( center top, #89c403 36%, #77a809 69% );
            background:-ms-linear-gradient( top, #89c403 36%, #77a809 69% );
            filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#89c403', endColorstr='#77a809');
            background:-webkit-gradient( linear, left top, left bottom, color-stop(36%, #89c403), color-stop(69%, #77a809) );
            background-color:#89c403;
            color:#ffffff;
            display:inline-block;
            text-shadow:1px 3px 0px #528009;
            -webkit-box-shadow:inset 1px 1px 0px 0px #a4e271;
            -moz-box-shadow:inset 1px 1px 0px 0px #a4e271;
            box-shadow:inset 1px 1px 0px 0px #a4e271;
            }
            .start-pacman:hover {
            background:-moz-linear-gradient( center top, #77a809 36%, #89c403 69% );
            background:-ms-linear-gradient( top, #77a809 36%, #89c403 69% );
            filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#77a809', endColorstr='#89c403');
            background:-webkit-gradient( linear, left top, left bottom, color-stop(36%, #77a809), color-stop(69%, #89c403) );
...
<div class="bodypacman">  
    <a href="pacman.php" class="start-pacman">Iniciar Jogo</a>  
    <svg id="game_screen"
         version="1.1"
         baseProfile="full"
         width="550"
